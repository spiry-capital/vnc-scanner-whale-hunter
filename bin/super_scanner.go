...
import (
	...
	tea "github.com/charmbracelet/bell/tea"
	"github.com/charmbracelet/lipgloss"
	"github.com/charmbracelet/bubbles/textinput"
	"github.com/charmbracelet/lipgloss/color"
	"github.com/charmbracelet/lipgloss/ansi"
	"github.com/charmbracelet/lipgloss/box"
	"github.com/charmbracelet/lipgloss/line"
	"github.com/charmbracelet/lipgloss/paragraph"
	"github.com/charmbracelet/lipgloss/style"
	"github.com/charmbracelet/lipgloss/table"
	"github.com/charmbracelet/lipgloss/terminal"
	"github.com/charmbracelet/lipgloss/width"
	"github.com/charmbracelet/lipgloss/height"
	"github.com/charmbracelet/lipgloss/border"
	"github.com/charmbracelet/lipgloss/padding"
	"github.com/charmbracelet/lipgloss/align"
	"github.com/charmbracelet/lipgloss/foreground"
	"github.com/charmbracelet/lipgloss/background"
	"github.com/charmbracelet/lipgloss/bold"
	"github.com/charmbracelet/lipgloss/italic"
	"github.com/charmbracelet/lipgloss/underline"
	"github.com/charmbracelet/lipgloss/strikethrough"
	"github.com/charmbracelet/lipgloss/border"
	"github.com/charmbracelet/lipgloss/padding"
	"github.com/charmbracelet/lipgloss/align"
	"github.com/charmbracelet/lipgloss/foreground"
	...
	"github.com/charmbracelet/lipgloss/width"
	"github.com/charmbracelet/lipgloss/height"
	"github.com/charmbracelet/lipgstyleError := styleError.Render("[ERROR] " + err.Error())
		fmt.Println(styleError)
		return
	}
	// Verifică dacă există un deep scan în curs
	if deepScanActive {
		deepScanStatusCh <- fmt.Sprintf("Deep scan: %s:%d [NOAUTH] Hostname: %s", ip, port, hostname)
	}
	// Trimite mesajul de finalizare
...
if strings.Contains(version, "RFB ") {
	versionParts := strings.Split(version, "RFB ")[1]
	majorMinor := strings.Split(versionParts, ".")
	if len(majorMinor) >= 2 {
